...
namespace Classified.Component.Html
{
    ...
    /// </summary>
    public static class LinkViewHelper
    {
        /// <summary>  
        /// Create an HTML tree from a recursive collection of items  
        /// </summary>  
        public static LinkView<T> LinkView<T>(this HtmlHelper html, IEnumerable<T> items)
        {
            return new LinkView<T>(html, items);
        }
    }
    ...
    public class LinkView<T> : IHtmlString
    {
        ...
        /// <returns></returns>
        public LinkView<T> SelectedValue(string selector)
        {
        ...
        public LinkView(HtmlHelper html, IEnumerable<T> items)
        {
        ...
        /// </summary>  
        public LinkView<T> ItemText(string selector)
        {
        ...
        /// The property which will display the text rendered for each item  
        /// </summary>  
        public LinkView<T> ItemValue(string selector)
        {
        ...
        /// </summary>  
        public LinkView<T> Children(Func<T, IEnumerable<T>> selector)
        {
        ...
        /// </summary>  
        public LinkView<T> PlaceHolder(string placeHolderText)
        {
        ...
        /// </summary>  
        public LinkView<T> HtmlAttributes(object htmlAttributes)
        {
        ...
        /// HTML attributes appended to the root ul node  
        /// </summary>  
        public LinkView<T> HtmlAttributes(IDictionary<string, object> htmlAttributes)
        {
        ...
        /// </summary>  
        public LinkView<T> ChildrenHtmlAttributes(object htmlAttributes)
        {
        ...
        /// HTML attributes appended to the children items  
        /// </summary>  
        public LinkView<T> ChildrenHtmlAttributes(IDictionary<string, object> htmlAttributes)
        {
        ...
        public override string ToString()
        {
            ...
            if (listItems.Count > 0)
            {
                ...
                rootLink.Attributes.Add("class", "dropdown-item");
                rootLink.Attributes.Add("data-value", "");
                rootLink.Attributes.Add("data-level", "1");
                rootLink.InnerHtml = _placeHolder;

                if (string.IsNullOrEmpty(_selectedValue))
                {
                    rootLink.Attributes.Add("data-default-selected", "");
                }


                //Add root link
                div.InnerHtml = $"{rootLink.ToString()}\n";
